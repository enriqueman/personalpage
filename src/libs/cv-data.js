...
export const cvData = {
  es: {
    ...
    webPageLabel: "Página web",
    proj1: "Portafolio web personal: sitio para la presentación de mi portafolio, construido en Next.js, alojado en S3 y desplegado en CloudFront y Route 53. Implementa entornos de desarrollo, pruebas y producción, desplegados mediante GitHub Actions con AWS SAM.",
    proj1Url: "www.enriquemv.com",
    proj2Title: "Sistema de gestión y publicación del blog Ataraxia",
    proj2: "Sistema de gestión y publicación del blog Ataraxia: CMS serverless Full Stack con panel administrativo en Next.js y publicación automática de blog estático. Microservicios AWS Lambda para autenticación JWT, gestión de contenido, procesamiento de imágenes en S3 y publicación automática con despliegue en GitHub Pages. Next.js 15, React 19, AWS Lambda, DynamoDB, S3, GitHub Actions.",
    proj2Url: "www.ataraxiapro.com",
